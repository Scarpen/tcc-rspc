...
Interest.create(name: 'Tecnologia', description:'')
Interest.create(name: 'Engenharia', description:'')
Interest.create(name: 'Arquitetura e Urbanismo', description:'')
Interest.create(name: 'Saúde', description:'')
Interest.create(name: 'Meio Ambiente', description:'')
Interest.create(name: 'Comunicação', description:'')
Interest.create(name: 'Serviço Social', description:'')
Interest.create(name: 'Design', description:'')
Interest.create(name: 'Educação', description:'')
Interest.create(name: 'Religião', description:'')
Interest.create(name: 'Música', description:'')
Interest.create(name: 'Dança', description:'')
Interest.create(name: 'Teatro', description:'')
Interest.create(name: 'Fotografia', description:'')
Interest.create(name: 'Moda', description:'')
Interest.create(name: 'Esporte', description:'')
Interest.create(name: 'Jogos', description:'')
Interest.create(name: 'Turismo', description:'')
